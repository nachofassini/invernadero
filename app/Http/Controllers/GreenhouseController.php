...
//         SELECT COUNT(isDayLight)
        ...
        // GROUP BY isDayLight
        $lastHoursLight = Measure::whereBetween('created_at', [Carbon::now(), Carbon::now()->subHours($activeStage->light_hours)])
    ...
    public function index()
    {
        ...
        $deviations = $this->getCropDeviations($activeStage, $lastMeasure);
